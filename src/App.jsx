  ...
  return (
    <>
      ...
      <div id="cards" className="d-flex justify-content-evenly">
        ...
        <Card className="col" title="😁" desc="😁" srcImage="https://i.ibb.co/rkrV2LP/Whats-App-Image-2023-05-18-at-11-46-43-AM.jpg" alt="😁"/>
        </div>
      </div>
      <Footer />
    </>
...
export default App;
 /**<img src="" alt="Whats-App-Image-2023-05-18-at-11-46-43-AM" border="0">*/